...
//  Photos
//
//  Created by Kirill Letko on 12/21/19.
...
open class ImageZoomView: UIScrollView {
    ...
    private func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ImageZoomView.changeOrientationNotification), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= maximumZoomScale / 2.0 {
            ...
            let zoomRect = zoomRectForScale(ImageZoomView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale, center: center)
